...
public class SkinHolder {
    ...
    public WrappedGameProfile getSkinFromPath(String path, Object vr, WrappedGameProfile profile) {
    ...
    public void genSkinFromFile(String path) {
        try {
            genSkinFromFile(path, null);
        } catch (NoSuchFieldException | SecurityException | IllegalArgumentException | IllegalAccessException
                | IOException e) {
            e.printStackTrace();
        }
    ...
    public void genSkinFromFile(String path, Object vr)
    ...
    public void genSkinFromFile(String path, Object vr, CustomVillager vi)
            throws IOException, NoSuchFieldException, SecurityException, IllegalArgumentException,
            IllegalAccessException {
        if (MComesToLife.enabledPlugins.isEnabled("SkinsRestorer")) {
            final String value = "";
